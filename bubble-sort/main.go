...
func BubbleSort(nums ...int) (sorted []int) {
	...
	/*
		kode untuk menentuan titik pointnya 
		jadi index i, akan bertugas sebagai point yang dibandingkan.
		lalu < len(nums)-1, karena kita hanya akan meletakkan tiitk point 
		di 1 index sebelum terakhir. Karena index terakhir akan diisi oleh pembandingnya
	*/
